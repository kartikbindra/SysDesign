...
## 1. Problem Statement
Implement a google docs application that, for now, has features of adding and removing text and image elements but may scale to more formatting, and other elements also in the future.
